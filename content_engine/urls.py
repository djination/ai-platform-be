...
urlpatterns = [
    ...
    path(
        ...
        SubscriptionManageView.as_view(),
        name="billing_subscription_manage",
    ),
    path("me/entitlement/", MeEntitlementView.as_view(), name="me_entitlement"),
    path("me/limits/", MeLimitsView.as_view(), name="me_limits"),
    path(
        "chat/sessions/<str:session_key>/",
        chat_session_detail,
        name="chat_session_detail",
    ),
    path("chat/sessions/", chat_sessions_list, name="chat_sessions_list"),
